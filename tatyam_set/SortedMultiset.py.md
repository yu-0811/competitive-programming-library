...
data:
  ...
  code: "# https://github.com/tatyam-prime/SortedSet/blob/main/SortedMultiset.py\n\
    ...
    \ Generic, Iterable, Iterator, TypeVar\nT = TypeVar('T')\n\nclass SortedMultiset(Generic[T]):\n\
    \    BUCKET_RATIO = 16\n    SPLIT_RATIO = 24\n    \n    def __init__(self, a:\
  ...
  verifiedWith: []
documentation_of: tatyam_set/SortedMultiset.py
layout: document
redirect_from:
- /library/tatyam_set/SortedMultiset.py
- /library/tatyam_set/SortedMultiset.py.html
