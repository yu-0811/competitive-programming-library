...
data:
  ...
  code: "# \u5358\u7D14\u9023\u7D50\u7121\u52B9\u30B0\u30E9\u30D5\u306E\u751F\u6210\
    ...
    \u30FC\u30B8\u5F8C\u306E\u6839\u3092\u8FD4\u3059 O(\u03B1(N))\n    def union(self,\
    \ x, y):\n        x = self.root(x)\n        y = self.root(y)\n        if x ==\
    \ y:\n            return x  # x,y \u304C\u540C\u3058\u30B0\u30EB\u30FC\u30D7\u306A\
    \u3089\u306A\u306B\u3082\u3057\u306A\u3044\n        # x,y \u306F\u6839\u3067\u3042\
    \u308A\u3001parents \u306E\u5024*-1 \u304C\u305D\u306E\u6728\u306E\u30B5\u30A4\
    \u30BA(\u8981\u7D20\u6570)\n        # \u30B5\u30A4\u30BA\u304C\u5C0F\u3055\u3044\
    \u65B9\u306B\u3064\u306A\u3052\u308B (union by size)\n        if self.parents[x]\
    \ > self.parents[y]:\n            x, y = y, x  # x \u304C\u5C0F\u3055\u3044\u65B9\
  ...
  verifiedWith: []
documentation_of: algorithm_library/python/gen/graph.py
layout: document
redirect_from:
- /library/algorithm_library/python/gen/graph.py
- /library/algorithm_library/python/gen/graph.py.html
