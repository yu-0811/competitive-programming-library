...
data:
  ...
  code: "# SA \u306E\u69CB\u7BC9\uFF1AO(|S|)\n# SA[i]: int \u3067 S \u306E SA[i] \u304B\
    ...
    \ = ls[i + 1] if (s[i] == s[i + 1]) else (s[i] < s[i + 1])\n    sum_l = [0] *\
    \ (upper + 1)\n    sum_s = [0] * (upper + 1)\n    for i in range(n):\n       \
    \ if not (ls[i]):\n            sum_s[s[i]] += 1\n        else:\n            sum_l[s[i]\
    ...
    \ = 0\n        for i in range(1, m):\n            l = sorted_lms[i - 1]\n    \
    \        r = sorted_lms[i]\n            end_l = lms[lms_map[l] + 1] if (lms_map[l]\
    \ + 1 < m) else n\n            end_r = lms[lms_map[r] + 1] if (lms_map[r] + 1\
    \ < m) else n\n            same = True\n            if end_l - l != end_r - r:\n\
    \                same = False\n            else:\n                while l < end_l:\n\
    \                    if s[l] != s[r]:\n                        break\n       \
    \             l += 1\n                    r += 1\n                if (l == n)\
    ...
    \ s[idx[i - 1]] != s[idx[i]]:\n                now += 1\n            s2[idx[i]]\
    \ = now\n        return sa_is(s2, now)\n\n\n# lcp[i] = S \u306E SA[i] \u6587\u5B57\
    \u76EE\u304B\u3089\u59CB\u307E\u308B suffix \u3068 S \u306E SA[i+1] \u6587\u5B57\
    \u76EE\u304B\u3089\u59CB\u307E\u308B suffix \u306E\u5171\u901A\u63A5\u982D\u8F9E\
    ...
    \    if s[j + h] != s[i + h]:\n                break\n            h += 1\n   \
    \     lcp[rnk[i] - 1] = h\n    return lcp\n\n\n# suffix \u3092\u30BD\u30FC\u30C8\
    \u3057\u3066 T <= x \u306A\u308B suffix x \u306E\u30A4\u30F3\u30C7\u30C3\u30AF\
    \u30B9\u3092\u8FD4\u3059\n# T <= S[SA[i] : SA[i] + len(T)] \u3092\u6E80\u305F\u3059\
