...
data:
  ...
  code: "# \u672Averified\n# \u30E1\u30E2\u30EA\u4F7F\u7528\u91CF\u306B\u6CE8\u610F\
    ...
    \n        # table[k][l][i][j]: \u5DE6\u4E0A (i, j)\u3001\u9AD8\u3055 2^k\u3001\
    \u5E45 2^l \u306E\u77E9\u5F62\u306B op \u3092\u9069\u7528\u3057\u305F\u7D50\u679C\
    \n        self.table = [\n            [[[0] * self.W for _ in range(self.H)] for\
    ...
    \ - 1][i][j], self.table[0][l - 1][i][j + half]\n                    )\n     \
    \   # \u5217\u65B9\u5411\u306E\u69CB\u7BC9 (\u4EFB\u610F\u306E\u5E45 l \u306B\u5BFE\
    \u3057\u3066\u9AD8\u3055\u3092\u62E1\u5927)\n        for k in range(1, self.K):\n\
    \            height = 1 << k\n            half = height >> 1\n            for\
    \ l in range(self.L):\n                width = 1 << l\n                for i in\
    \ range(self.H - height + 1):\n                    for j in range(self.W - width\
    ...
    \ <= c1 <= c2 < self.W\n\n        height = r2 - r1 + 1\n        width = c2 - c1\
    \ + 1\n        k = height.bit_length() - 1  # 2^k <= height \u3092\u6E80\u305F\
    \u3059\u6700\u5927\u306E k\n        l = width.bit_length() - 1  # 2^l <= width\
    \ \u3092\u6E80\u305F\u3059\u6700\u5927\u306E l\n\n        r2_start = r2 - (1 <<\
    \ k) + 1\n        c2_start = c2 - (1 << l) + 1\n\n        # 4\u3064\u306E\u9577\
    \u65B9\u5F62\u3067 (r1,c1)~(r2,c2) \u3092\u30AB\u30D0\u30FC\u3059\u308B\n    \
